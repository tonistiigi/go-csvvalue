// Package legacy retains the pre-split Fields implementation for tests and benchmarks.
package legacy
...
// Parser is the pre-split CSV parser retained for tests and benchmarks.
type Parser struct {
	Comma            rune
	LazyQuotes       bool
